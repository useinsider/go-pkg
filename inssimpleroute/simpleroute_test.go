...
type badMarshalError struct{}

func (badMarshalError) Error() string                { return "cannot marshal me" }
func (badMarshalError) MarshalJSON() ([]byte, error) { return nil, errors.New("marshal broken") }
...
func TestSimpleRoute_ServeHTTP(t *testing.T) {
	...
	t.Run("it_should_encode_use_case_error", func(t *testing.T) {
		failing := func(_ context.Context, _ *echoCommand) (echoResult, error) {
			return echoResult{}, statusError{code: http.StatusTeapot, msg: "teapot"}
		}
...
func TestDefaultErrorEncoder(t *testing.T) {
	...
	t.Run("it_should_fall_back_to_plain_text_when_marshaling_fails", func(t *testing.T) {
		rec := httptest.NewRecorder()
		inssimpleroute.DefaultErrorEncoder(context.Background(), badMarshalError{}, rec)
	...
	t.Run("it_should_use_json_headers_and_status_from_error", func(t *testing.T) {
		rec := httptest.NewRecorder()
		inssimpleroute.DefaultErrorEncoder(context.Background(), statusError{code: http.StatusConflict, msg: "dupe"}, rec)
